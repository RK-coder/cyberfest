...
<body>
 ...
 <div class="row">   
  ...
  <h2 style="margin-top:65px;">Coimbatore Institute Of Technology</h2>  </div>
    ...
    <a href="event1.php"class="active">Quantum Quest</a>
...
<div class="container">
  <h1 style="text-align: center;">Event-1   &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<a href="event1-export.php"><button type="button" class="btn btn-danger">Export</button></a></h1>
