...
<body>
  <div class="topnav" id="myTopnav">
    ...
    <a href="event4.php"class="active">Maze Runners</a>
...
<div class="container">
  <br><br>
  <h1 style="text-align: center;">Event-4   &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<a href="event4-export.php"><button type="button" class="btn btn-danger">Export</button></a></h1>
  <br>
    <table class="table table-bordered table-info">
      ...
      <?php
include "db_conn.php";
$query="SELECT r.*,re.* FROM register r, registrations re WHERE r.id=re.id and re.event_name='MAZE RUNNERS' and re.status=1  order by r.college";
