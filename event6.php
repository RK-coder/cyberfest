...
<body>
  <div class="topnav" id="myTopnav">
    ...
    <a href="event6.php"class="active">Stickeez Mate</a>
...
<div class="container">
  <br><br>
  <h1 style="text-align: center;">Event-6   &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<a href="event6-export.php"><button type="button" class="btn btn-danger">Export</button></a></h1>
  <br>
    <table class="table table-bordered table-info">
      ...
      <?php
include "db_conn.php";
$query="SELECT r.*,re.* FROM register r, registrations re WHERE r.id=re.id and re.event_name='STICKEEZ MATE' and re.status=1  order by r.college";
